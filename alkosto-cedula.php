		...
		if( abrirbd($link) ){
			...
			if( $result=consulta($sql, $link) ){
				...
				if( $fila=trae_fila($result) ){
					...
					if($_SESSION['frase'] == ''){
						header('location: alkosto-frase-secreta.php');
					}else{
						$error1 = 'ya ingresaste la frase';
					}
				}else{
					$error1 = 'C&eacute;dula incorrecta';
				}

			}else{

				$error1 = 'error en ejecuci&oacute;n de query';
			}
...
<div id="contenedor">
  ...
  <div id="dos">
    <div id="cedula">
    	<form action="alkosto-cedula.php" method="POST">
    ...
    <p id="notificacion"><?php echo $error1; ?></p>
  </div>
  <div class="clear">
    <div id="tres"></div>
    <div id="cuatro"> </div> 
