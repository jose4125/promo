...
header('location: lumix-cedula.php');
}
...
<div id="contenedor">
  ...
  <div id="dos">
    <div id="frase">
    <form action="lumix-frase-secreta.php" method="POST">
      <table width="600" border="0">
        <tr>
          <td class="datoscedula">Frase Secreta</td>
          <td><input name="frase" type="text" class="roundedcorner3" size="60" /></td>
          <td><input name="fan" type="hidden" class="roundedcorner3" value="lumix" size="60" /></td>
